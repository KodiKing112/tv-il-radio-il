...
public class Helper extends JFrame {
	...
	public Helper() {
		...
		setTitle("Grab Any Media | AdobeHDS.php Helper");
		...
		btnStart.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				String adobeLibs = "libs/AdobeHDS.php";
				...
				if(manifest.length() < 1 || output.length() < 1){
					...
					try{
						...
						if(manifest.indexOf("http") == 0){
							...
							command = "php " + adobeLibs + " --manifest \"" + manifest + "\" --outfile \"output/" + output + "\"";
						
						}else{
							
							command = "php " + adobeLibs + " --fragments \"fragments/" + manifest + "\" --outfile \"output/" + output + "\"";
